...
require_once '../includes/csrf.php'; // Include CSRF for both GET and POST
...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    try {
        ...
        if ($admins_result->num_rows > 0) {
            ...
            $link = "admin/review_submissions.php?task_id={$task_id}";
...
<head>
    ...
    <style>
        ...
        * { margin: 0; padding: 0; box-sizing: border-box; }
        ...
        /* Mobile & Responsive */
        .menu-toggle { display: none; background: none; border: none; cursor: pointer; padding: 0; position: absolute; top: 1rem; left: 1rem; z-index: 1001; }
